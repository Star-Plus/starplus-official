<script>
    ...
    import PixelLed from "./canvas/PixelLed.svelte";
...
>
    ...
    >
        <div class="size-16 mx-auto mb-8">
            <img src="Sp_Logo.png" alt="" class="selection:bg-transparent! w-full h-full object-contain" />
        </div>
